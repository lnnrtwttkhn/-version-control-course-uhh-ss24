...
####  Collaborate with pull requests (using "GitHub flow")

1. Find a partner.
1. Using a GUI, clone their repository if not already done (pull).
...
1. Review the Pull Request and create a coherent recipe.
