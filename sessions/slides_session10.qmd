---
title: "Session 10: GitHub with the world"
date: 2024-06-10
format: revealjs
metadata-files:
  - _slides.yml
...
# This session's topic: "Github with the world"

## Today's topic: "Github with the world"
...
1. Create an **issue** indicating a missing recipe
1. Repeat the steps from the previous exercise using the forked repository:
    ...
    1. Use the **contributing guide** in Lennart´s repo to create a new recipe
