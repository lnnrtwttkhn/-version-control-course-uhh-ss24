...
:::: {.column width="33%"}
::: fragment
#### **Private collaboration** with pull requests (GitHub flow)
...
::: {.column width="33%"}
::: fragment
#### Complete the [GitHub Quiz](https://version-control-github.formr.org)
:::
:::

::: {.column width="33%"}
::: fragment
#### **Clean up** your repo and enhance your `README` (optional)
:::
:::
::::
