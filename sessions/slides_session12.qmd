...
Create an annotated tag on the main branch in your recipe repo named `v1.0.0.`
...
1. Link your GitHub account to Zenodo:
 ...
 - Navigate to the “GitHub” tab in your Zenodo settings.
...
1. Go to the Zenodo sandbox and mint a DOI
:::
::::
:::::
