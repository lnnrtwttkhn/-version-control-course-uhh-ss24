...
1. {{< fa dumbbell >}} **Exercises**: Complete the [quiz "basics"](https://version-control-basics.formr.org/).
:::
...
:memo: **Add Content:** Write down a recipe—any favorite or an intriguing AI-generated one in recipes.txt. <br>
